...
var level_metadata_controller := SaveLevelMetadataController.new()
...
func _ready():
	...
	level_metadata_controller.setup(self)
	load_settings()
...
func get_save_display_name(level_path: String, level_state: Dictionary, _saved_quest_states: Variant = {}) -> String:
	return level_metadata_controller.get_save_display_name(level_path, level_state, _saved_quest_states)


func get_level_metadata(level_path: String) -> Dictionary:
	return level_metadata_controller.get_level_metadata(level_path)


func get_current_level_metadata() -> Dictionary:
	return level_metadata_controller.get_current_level_metadata()


func get_level_location_label(level_path: String, include_index: bool = false) -> String:
	return level_metadata_controller.get_level_location_label(level_path, include_index)


func get_level_display_name_fallback(level_path: String) -> String:
	return level_metadata_controller.get_level_display_name_fallback(level_path)


func get_title_dev_level_entries() -> Array:
	return level_metadata_controller.get_title_dev_level_entries()


func sort_dev_level_entry_by_index(a: Dictionary, b: Dictionary) -> bool:
	return level_metadata_controller.sort_dev_level_entry_by_index(a, b)
