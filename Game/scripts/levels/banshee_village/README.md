...
The scene keeps `BansheeVillageFlowController` as the public coordinator and save provider. Helpers in this folder may own focused behavior, but they should not become independent save providers unless a migration plan preserves existing saves.
