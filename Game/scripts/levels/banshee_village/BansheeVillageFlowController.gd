...
@export_enum(
	"none",
	"start",
	"banshee_combat_first_hunt_start",
	"first_report_available",
	"dulluhan_visible",
	"wolf_transformation_unlocked",
	"second_hunt_start",
	"second_report_available",
	"dulluhan_in_front_of_house",
	"upgraded_banshees_enabled",
	"third_hunt_start",
	"third_report_available_bishop_request",
	"bishop_request_still_available",
	"bishop_defeated",
